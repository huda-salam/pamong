# tools/pamongctl — CLI Framework

Perintah utama:
- pamongctl new module — scaffold modul baru
- pamongctl define entity — definisi entity via YAML
...
- pamongctl rule create|preview|activate — manajemen rule
- pamongctl audit verify — verifikasi hash chain
